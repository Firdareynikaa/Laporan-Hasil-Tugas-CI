...
<div class="modal fade" id="tambah" >
	...
	<div class="modal-header" style="background-color: #A52A2A;">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="modal-title" style="color: #000; font-size: 22px;">Tambah Kasir</div>
			</div>
			<div class="col-md-6">
	...
	<table>
		...
		<tr>
		<td style="color: #fff; font-size: 15px;">nama user</td>
		<td><input type="text" name="nama_user" required style="margin-left: 20px;"></td>
		</tr>

		<tr>
		<td style="color: #fff; font-size: 15px;">username</td>
		<td><input type="text" name="username" required style="margin-left: 20px;"></td>
		</tr>

		<tr>
		<td style="color: #fff; font-size: 15px;">password</td>
...
<div class="modal fade" id="ubah" >
	...
	<div class="modal-header" style="background-color: #A52A2A;">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="modal-title" style="color: #000; font-size: 22px;">Ubah Kasir</div>
			</div>
			<div class="col-md-6">
				<button class="btn " data-dismiss = "modal" style="float: right; ">X</button>
				</div>
